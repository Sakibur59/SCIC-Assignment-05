...
import { FaStar, FaStarHalf, FaBuilding, FaMapMarkerAlt, FaCalendarAlt, FaClock, FaDollarSign } from 'react-icons/fa'
          ...
          <div className="w-20 h-20 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
            {job.companyLogo ? (
              <img
                ...
                onError={(e) => {
                  e.target.src = 'https://via.placeholder.com/64/3b82f6/ffffff?text=' + job.company[0];
                }}
              />
            ) : (
              <span className="text-3xl font-bold text-primary-600">{job.company[0]}</span>
            )}
          </div>
        ...
        <div className="p-6">
          ...
          {activeTab === 'company' && (
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900">About {job.companyInfo.name}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="font-semibold">{job.companyInfo.headquarters}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-500">Website</p>
                  <a href={job.companyInfo.website} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline font-semibold">
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-bold text-primary-600">{job.rating}</span>
